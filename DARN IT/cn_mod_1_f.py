...
class Ui_MainWindow_mod(object):
    ...
    def setupUi_mod(self, MainWindow,mod_no,year,marks):
        ...
        self.frame.setMinimumSize(QtCore.QSize(5000,18500))
        ...
        self.yt = QtWidgets.QPushButton(self.centralwidget, clicked=lambda: webbrowser.open(
            'http://www.google.com'))  # just put the required url
        ...
        self.label_19.setPixmap(
            QtGui.QPixmap("C:\\Users\\niran\\Desktop\\courses\\ML other\\MPR_backend\\try2-dark-stripes-background-elegant-design-wallpapers_518299-1505.jpg"))
